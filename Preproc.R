...
trial_time<- trialTime(data_list = 'C:/Data/corr_sacc/padded',
                       maxtrial = 90)
trial_time <- read.csv("trial_time.csv")
...
raw_fix <-read.csv("raw_fixations.csv")
...
rs  <- read.csv("return-sweep_data.csv")
qst <- read.csv("quest.csv")              
fix <- read.csv("raw_fixations.csv")     
